...
In the following the concept of boosting is explained in two steps. To get a good grasp of the idea behind boosting we first introduce what we call *residual boosting*.
