...
## Literature
* Section **4.3** in "Regression: Models, methods, and applications" by Ludwig Fahrmeir, Thomas Kneib, Stefan Lang, and Brian Marx, especially Section 2.9.1 on "Regression models for location, scale, and shape"
